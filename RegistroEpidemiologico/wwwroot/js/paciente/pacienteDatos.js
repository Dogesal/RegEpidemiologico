    ...
    $(document).ready(function () {
        new DataTable('#dataTablaPaciente', {
            ajax: {
                url: '/Paciente/getPacientes', // Endpoint para cargar los datos
            ...
            columns: [
                ...
                { data: 'sexo' },
                {
                    ...
                    render: function (data, type, row) { 
                        return `
                <button class="btn btn-primary" title="Seleccionar" onclick="Seleccionar('${row.dni}','${row.historia}')">
            ...
            columnDefs: [
                { targets: [1], visible: false } // Oculta la segunda columna (índice 1) que es la columna "historia"
            ],
            responsive: true,
            language: {
